...
def calculate_read(adc_port, adc_repo, voltage_ref):
    ...
    current_conv_factor_port0 = 0.02674548 * squareroot2          # Conversion factor to get I(peak) (Due tu resistance precision, every port has to be configure differently)
    current_conv_factor_port1 = 0.02674548 * squareroot2
    current_conv_factor_port2 = 0.02640527 * squareroot2
    current_conv_factor_port3 = 0.02651524 * squareroot2
    current_conv_factor_port4 = 0.02637314 * squareroot2
    current_conv_factor_port5 = 0.02669338 * squareroot2
    current_conv_factor_port6 = 0.02645705 * squareroot2
    ...
    #
    # print("CURRENT ----------------------------")
    # for i in range(len(current_list7)):
    #     print(current_list7[i])
